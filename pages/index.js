        ...
        <ThemeProvider>
          ...
          <Flex justifyContent="center" flexWrap="wrap" paddingTop="5%" paddingBottom="5%" paddingRight="10%" paddingLeft="10%">
            ...
            <Box width="100%" height="100px"></Box>
              ...
              <Button color="#E0783F" fontFamily="Zilla Slab" fontSize={["14px", "14px", "2xl","2xl"]} padding="2%" backgroundColor="#FFE1B5" variant="solid" onClick={()=> this.setState({contents: "open"})}>Pick a New Category!</Button>
                <Flex width="50%" justifyContent="flex-end">
                  <Button color="#E0783F" fontFamily="Zilla Slab" fontSize={["14px", "14px", "2xl","2xl"]} padding="2%" backgroundColor="#FFE1B5" variant="solid" onClick={()=> this.setState({index: this.state.index - 1})}>Back</Button>
                  <Box width="30px"></Box>
                  <Button color="#E0783F" fontFamily="Zilla Slab" fontSize={["14px", "14px", "2xl","2xl"]} padding="2%" backgroundColor="#FFE1B5" variant="solid" onClick={()=> this.setState({index: this.state.index + 1})}>Next</Button>
                </Flex>
              </Flex>
